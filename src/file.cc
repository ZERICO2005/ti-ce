...
bool load_console_state_smem(const char * filename) {
  ...
  if (strncmp(hf, "#xwaspy\n", 8) == 0) {
    ...
    for (; *source; source += 4) {
      ...
      if (!*source)
        break;
      unsigned char a = source[0] - xwaspy_shift, b = source[1] - xwaspy_shift, c = source[2] - xwaspy_shift, d = source[3] -
                      xwaspy_shift;
      str += char((a << 2) | (b >> 4));
      str += char((b << 4) | (c >> 2));
      str += char((c << 6) | d);
  ...
  for (;;) {
    ...
    unsigned char type = *hf;
    ++hf;
    unsigned char readonly = *hf;
    ++hf;
    char buf[l + 1];
...
string detokenize(const unsigned char * ptr, int len) {
  ...
  case 0xb8:
    ...
    */
    ...
    case 0xac:
      buf[0] = 'p';
      buf[1] = 'i'; // strcpy(buf,"pi");
      continue;
    case 0xb2:
      buf[0] = 'a';
      buf[1] = 'b';
      buf[2] = 's';
      buf[3] = '('; // strcpy(buf,"abs(");
      continue;
    case 0xb3:
      buf[0] = 'd';
      buf[1] = 'e';
      buf[2] = 't';
      buf[3] = '('; // strcpy(buf,"det(");
      continue;
    case 0xb4:
      buf[0] = 'i';
      buf[1] = 'd';
      buf[2] = 'n';
      buf[3] = '('; // strcpy(buf,"idn(");
      continue;
    case 0xb5:
      buf[0] = 'd';
      buf[1] = 'i';
      buf[2] = 'm';
      buf[3] = '('; // strcpy(buf,"dim(");
      continue;
    case 0xb6:
      buf[0] = 's';
      buf[1] = 'u';
      buf[2] = 'm';
      buf[3] = '('; // strcpy(buf,"sum(");
      continue;
    case 0xb7:
      strcpy(buf, "product(");
      continue;
    ...
    case 0xbb:
      ...
      if (c == 8) {
        ...
        buf[1] = 'c';
        buf[2] = 'm';
        buf[3] = '('; // strcpy(buf,"lcm(");
      } else if (c == 9) {
        buf[0] = 'g';
        buf[1] = 'c';
        buf[2] = 'd';
        buf[3] = '('; //strcpy(buf,"gcd(");
      } else if (c == 0x25) {
        buf[0] = 'c';
        buf[1] = 'o';
        buf[2] = 'n';
        buf[3] = 'j';
        buf[4] = '('; // strcpy(buf,"conj(");
      } else if (c == 0x26) {
        buf[0] = 'r';
        buf[1] = 'e';
        buf[2] = '('; //strcpy(buf,"re(");
    ...
    case 0xc3:
      ...
      buf[2] = 'i';
      buf[3] = 'n';
      buf[4] = '('; // strcpy(buf,"asin(");
      continue;
    case 0xc4:
      buf[0] = 'c';
      buf[1] = 'o';
      buf[2] = 's';
      buf[3] = '('; // strcpy(buf,"cos(");
      continue;
    case 0xc5:
      buf[0] = 'a';
      buf[1] = 'c';
      buf[2] = 'o';
      buf[3] = 's';
      buf[4] = '('; // strcpy(buf,"acos(");
      continue;
    case 0xc6:
      buf[0] = 't';
      buf[1] = 'a';
      buf[2] = 'n';
      buf[3] = '('; // strcpy(buf,"tan(");
      continue;
    case 0xc7:
      buf[0] = 'a';
      buf[1] = 't';
...
bool dfc2s(real_t x, double eps, char * buf) {
  ...
  int type = ptr[0];
  if (type == 0x1c) {
    // internal format thanks to Adrien Bertrand
