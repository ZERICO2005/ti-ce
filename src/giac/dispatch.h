...
#define DOUBLEVAL 1
  ...
  enum color_values : int_least32_t {
#if 0
    _BLACK = INT32_C(1),
    _BLUE = INT32_C(7),
    _GREEN = INT32_C(4),
    ...
    _BLACK = INT32_C(0),
    _RED = INT32_C(0xf800),
    _GREEN = INT32_C(0x3f)<<5,
    _YELLOW = INT32_C(0xffe0),
    _BLUE = INT32_C(0x001f),
    _MAGENTA = INT32_C(0xf81f),
    _CYAN = INT32_C(0x07ff),
    _WHITE = INT32_C(0xffff),
#endif
    _POINT_LOSANGE= INT32_C(1) << 25,
    _POINT_PLUS = INT32_C(1) << 26,
    _POINT_INVISIBLE = INT32_C(1) << 27,
    _POINT_CARRE = INT32_C(100663296),
    _POINT_TRIANGLE = INT32_C(167772160),
    _POINT_ETOILE = INT32_C(201326592), 
    _POINT_POINT = INT32_C(234881024),
    _FILL_POLYGON = INT32_C(1) << 30,
    _QUADRANT1 = INT32_C(0),
    _QUADRANT2 = INT32_C(1) << 28,
    _QUADRANT3 = INT32_C(1) << 29,
    _QUADRANT4 = INT32_C(805306368),
    _DASH_LINE = INT32_C(1) << 22,
    _DOT_LINE = INT32_C(2) << 22,
    _DASHDOT_LINE = INT32_C(3) << 22,
    _DASHDOTDOT_LINE = INT32_C(4) << 22,
    _CAP_FLAT_LINE = INT32_C(5) << 22,
    _CAP_ROUND_LINE = INT32_C(6) << 22,
    _CAP_SQUARE_LINE = INT32_C(7) << 22,
    _LINE_WIDTH_1 = INT32_C(0),
    _LINE_WIDTH_2 = INT32_C(1) << 16,
    _LINE_WIDTH_3 = INT32_C(2) << 16,
    _LINE_WIDTH_4 = INT32_C(3) << 16,
    _LINE_WIDTH_5 = INT32_C(4) << 16,
    _LINE_WIDTH_6 = INT32_C(5) << 16,
    _LINE_WIDTH_7 = INT32_C(6) << 16,
    _LINE_WIDTH_8 = INT32_C(7) << 16,
    _POINT_WIDTH_1 = INT32_C(0),
    _POINT_WIDTH_2 = INT32_C(1) << 19,
    _POINT_WIDTH_3 = INT32_C(2) << 19,
    _POINT_WIDTH_4 = INT32_C(3) << 19,
    _POINT_WIDTH_5 = INT32_C(4) << 19,
    _POINT_WIDTH_6 = INT32_C(5) << 19,
    _POINT_WIDTH_7 = INT32_C(6) << 19,
    _POINT_WIDTH_8 = INT32_C(7) << 19,
#ifdef BESTA_OS
#pragma diag_suppress 61
#endif
    _HIDDEN_NAME = INT32_C(1) << 31
  };
