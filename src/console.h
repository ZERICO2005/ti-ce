...
void draw_filled_arc(int x, int y, int rx, int ry, int theta1_deg, int theta2_deg, int color = 0, int xmin = 0, int xmax = 384,
                     int ymin = 0, int ymax = 218, bool segment = false);
